...
<head>
    ...
    <style>
        * {
        ...
        .module-card .card-icon.purple {
            background: var(--brand-subtle);
            color: var(--brand);
        }
        .module-card .card-icon.green {
            background: var(--accent-green-bg);
            color: var(--accent-green);
        }
        .module-card .card-icon.blue {
            background: var(--accent-blue-bg);
            color: var(--accent-blue);
        }
        .module-card .card-icon.orange {
            background: var(--accent-orange-bg);
            color: var(--accent-orange);
        }
    ...
    <div class="container">
        ...
        <div class="modules-grid">
            ...
            <div class="module-card">
                ...
                <p>Review customer directories, modify loyalty account details, and handle baseline balance adjustments.</p>
            ...
            <div class="module-card">
                ...
                <p>Update baseline gift lists, configure tier activation paths, or check redemption items criteria.</p>
                <a href="/manage-rewards">
                    Manage Tiers
                    <span class="arrow">→</span>
                </a>
            </div>
            ...
            <div class="module-card">
                ...
                <p>Run points validation checks, monitor general redemption volumes, and print action logs spreadsheets.</p>
